"""
captura_rasp.py — Captura de imágenes en la Raspberry Pi
==========================================================
Usa la cámara CSI con Picamera2 para capturar imágenes
de tuercas y tornillos para el dataset de entrenamiento.

Uso:
    python captura_rasp.py
...
Las imágenes se guardan en la carpeta 'dataset/' con el
nombre de la clase como prefijo.

Dependencias:
    sudo apt install python3-picamera2
    pip install opencv-python-headless picamera2
"""
...
def main():
    ...
    while True:
        ...
        cv2.imshow("Captura - Raspberry Pi", display)
